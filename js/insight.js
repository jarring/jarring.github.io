 ...
 * @author Blogger { @link https://github.com/blogger }
 */
(function ($, CONFIG) {
    var $main = $('.ins-search');
        ...
        switch (type) {
            ...
            case 'PAGES':
                $searchItems = array.map(function (item) {
                    ...
                    return searchItem('file', item.title, null, item.text?.slice(0, 150), CONFIG.BASE_URL + item.path);
                });
                break;
            case 'CATEGORIES':
            case 'TAGS':
                $searchItems = array.map(function (item) {
                    return searchItem(type === 'CATEGORIES' ? 'folder' : 'tag', item.name, item.slug, null, CONFIG.BASE_URL + item.path);
                });
                break;
            default:
                return null;
